...
class Critic(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Sequential(
            ...
            nn.Conv2d(init_channel, init_channel, 3, padding=1),
            nn.LeakyReLU(slope)
        )
        ...
        self.conv2 = nn.Sequential(
            ...
            nn.Conv2d(init_channel * 2, init_channel * 2, 3, padding=1),
            nn.LeakyReLU(slope)
        ...
        self.conv3 = nn.Sequential(
            ...
            nn.Conv2d(init_channel * 4, init_channel * 4, 3, padding=1),
            nn.LeakyReLU(slope)
        ...
        self.conv4 = nn.Sequential(
            ...
            nn.Conv2d(init_channel * 8, init_channel * 8, 3, padding=1),
            nn.LeakyReLU(slope)
...
for epoch in range(epoch_num):
    ...
    for step, (real_data, target) in enumerate(data_loader, 1):
        ...
        if step % 20 is 0:
            ...
            fake_img = torchvision.utils.make_grid((0.5 * net_g(get_noise(64)).data.cpu() + 0.5))
            cv.imwrite('./img/WGAN/' + str(number) + '.png', fake_img.permute(1, 2, 0).numpy() * 255)
